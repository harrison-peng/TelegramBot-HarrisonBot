...
func Handler(res http.ResponseWriter, req *http.Request) {
	...
	if body.Message.MessageID == 0 {
		...
		if err := handleCallbackData(body.CallbackQuery); err != nil {
			fmt.Println("Error in handling callback data: ", err)
			return
		}
	} else {
		// Handle text message
		if err := handleMessage(body.Message); err != nil {
...
func main() {
	...
	// id, err := insertUser(client, "851464013", "Harrison", "Peng")
	// if err != nil {
	// 	fmt.Println(err)
	// 	return
	// }
	// fmt.Println("Insert: ", id)
	// err = addStock(client, "851464013", "2886")
	// if err != nil {
	// 	fmt.Println(err)
	// 	return
	// }
	// fmt.Println("Update: 851464013")
}
